...
def parse(filePath):
    ...
    """
    Define an empty list to hold our INT type data values
    """
    data = []
    ...
    with open(filePath, 'r') as iFile:
        ...
        for rowListOfValues in i:
             ...
             for columnSingleDataValue in rowListOfValues[1:]:
                 # Parse string value from CSV file to INT type value to represent the data values
                 dataValueCount = int(columnSingleDataValue)
                 # Add taxCount value onto 'data' list
                 data.append(dataValueCount)
